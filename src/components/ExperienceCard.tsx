  ...
  return (
    <article className="flex flex-col rounded-lg items-center flex-shrink-0 space-y-7 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] p-10 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden">
      <motion.img
        ...
        src="https://media.licdn.com/dms/image/D560BAQGjn7q1eTEG3Q/company-logo_200_200/0/1681958681937?e=1691625600&v=beta&t=UwLUjbadSvtzvibWnvI9eNKYYQ1KaOlb0r4mGToqYrA"
      />
      <div className="px-0 md:px-10">
        <h4 className="text-4xl font-light">Front End Developer</h4>
        <p className="font-bold text-2xl mt-1">Logituit</p>
